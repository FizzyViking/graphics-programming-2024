...
#include <iostream>
//00.1 locate and include headers
...
int main()
{
    ...
    // 00.1 replace VBO, VAO handles with new classes
    ...
    ebo.Bind();
    ebo.AllocateData<unsigned int>(std::span(indices, sizeof(unsigned int) / sizeof(indices)));
    ...
    while (!window.ShouldClose())
    {
        ...
        // render
        // ------
        deviceGL.Clear(0.8f, 0.3f, 0.4f, 1.0f); // 0.3 -> 0.8, 0.3 -> 0.4 redish color
